...
//                        console.log('mark 26');
                ...
                {bubble.change_bubble_shape('cyan', 4);  countwin=chosen_arc_id+1;             results.innerHTML ='Вы выиграли '+countwin+' баллов'; sendMessage('L');console.log('mark 28');}
                bubble.info = true;
...
//        }
    ...
    p.mousePressed = () => {
        console.log('Hell 1 o')
//        document.dispatchvent(myJsPsynchEvents.setup);
//        document.dispatchEvent(myJsPsynchEvents.trigger);
//        event_happened();
    };
    p.keyPressed = function() {
//    console.log('ASCII Value : '+p.key + " " +p.keyCode);
//    p.background(200);
